...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__angular_core__["b" /* NgModule */])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__angular_http__["b" /* BaseRequestOptions */]
        ],
    ...
    backend.connections.subscribe(function (connection) {
        ...
        setTimeout(function () {
            ...
            if (connection.request.url.endsWith('/api/authenticate') &&
                connection.request.method === __WEBPACK_IMPORTED_MODULE_0__angular_http__["e" /* RequestMethod */].Post) {
            ...
            if (connection.request.url.endsWith('/api/orders') &&
                connection.request.method === __WEBPACK_IMPORTED_MODULE_0__angular_http__["e" /* RequestMethod */].Get) {
                if (connection.request.headers.get('Authorization') === 'Bearer ' + token) {
                    connection.mockRespond(new __WEBPACK_IMPORTED_MODULE_0__angular_http__["f" /* Response */](new __WEBPACK_IMPORTED_MODULE_0__angular_http__["g" /* ResponseOptions */]({ status: 200, body: [1, 2, 3] })));
                }
                else {
...
OrderService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_http__["h" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_http__["h" /* Http */]) === "function" && _a || Object])
], OrderService);
